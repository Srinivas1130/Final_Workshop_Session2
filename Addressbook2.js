...
const createInnerHtml = () => {
  ...
  for (let contact of contactList) {
    innerHtml = `${innerHtml} 
        ...
        <td>
            <img src="C:\\Users\\Admin\\eclipse-workspace\\BridgeLabz\\Day_38\\delete.svg" id="${contact._id}" onclick="remove(this)">
            <img src="C:\\Users\\Admin\\eclipse-workspace\\BridgeLabz\\Day_38\\edit.svg" alt="update" id="${contact._id}" onclick="update(this)">
        </td>
        </tr>`;
  }
